...
@section('page_title', __('Admin-panel Check Request'))
        ...
        <div class="row" id="check_request">
            <div class="col-md-12">
                <div class="admin-section-title">
                    <h3><i class="voyager-list"></i>check Request</h3>
                </div>
                <div class="clear"></div>
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <button class="btn btn-block btn-success" v-on:click="approve({{$user->id}})">Approve</button>
                            </div>
                            <div class="col-6">
                                <button class="btn btn-block btn-warning" v-on:click="reject({{$user->id}})">Reject</button>
                            </div>
                        </div>
                    </div>
                </div>
